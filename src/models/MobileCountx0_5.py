...
class MobileCount(nn.Module):
    ...
    def __init__(self, num_classes=1, pretrained=False):
        ...
        self.layer4 = self._make_layer(block, 128, layers[3], stride=2, expansion=6)

        self.dropout4 = nn.Dropout(p=0.5)
        self.p_ims1d2_outl1_dimred = conv1x1(128, 32, bias=False)
        self.mflow_conv_g1_pool = self._make_crp(32, 32, 4)
        self.mflow_conv_g1_b3_joint_varout_dimred = conv1x1(32, 16, bias=False)

        self.dropout3 = nn.Dropout(p=0.5)
        self.p_ims1d2_outl2_dimred = conv1x1(64, 16, bias=False)
        self.adapt_stage2_b2_joint_varout_dimred = conv1x1(16, 16, bias=False)
        self.mflow_conv_g2_pool = self._make_crp(16, 16, 4)
        self.mflow_conv_g2_b3_joint_varout_dimred = conv1x1(16, 16, bias=False)

        self.p_ims1d2_outl3_dimred = conv1x1(32, 16, bias=False)
        self.adapt_stage3_b2_joint_varout_dimred = conv1x1(16, 16, bias=False)
        self.mflow_conv_g3_pool = self._make_crp(16, 16, 4)
        self.mflow_conv_g3_b3_joint_varout_dimred = conv1x1(16, 16, bias=False)

        self.p_ims1d2_outl4_dimred = conv1x1(16, 16, bias=False)
        self.adapt_stage4_b2_joint_varout_dimred = conv1x1(16, 16, bias=False)
        self.mflow_conv_g4_pool = self._make_crp(16, 16, 4)

        self.dropout_clf = nn.Dropout(p=0.5)
        # self.clf_conv = nn.Conv2d(256, num_classes, kernel_size=3, stride=1,
        #                           padding=1, bias=True)
        self.clf_conv = nn.Conv2d(16, 1, kernel_size=3, stride=1,
                                  padding=1, bias=True)
